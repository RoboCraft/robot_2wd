...
void orcp2::ORCP2::drive_2wd(uint16_t pwm0, uint16_t pwm1)
{
	uint8_t msg[2*sizeof(uint16_t)];
	int l=0;
	...
	uint16_t msg_size = orcp2::to_buffer(ORCP2_MESSAGE_ROBOT_2WD_DRIVE, msg, sizeof(msg), buf, sizeof(buf));
